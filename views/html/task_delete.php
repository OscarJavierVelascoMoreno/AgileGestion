    ...
    <?php
        ...
        if (isset($_POST['delete_task'])) {
            if (isset($_GET['tsk'])){
                ...
                header('Location: ./task_page.php?tsk=1');
            }
        }
                ...
                <div style="width: 100%; height: 90%; display: flex; flex-direction: row;">
                    <div style="width: 100%; margin: top 0 right 5% left 5% down 0;">
                        ...
                        <div style="width: 80%; height: 13%; border: 1px solid black; margin: 5%; background-color: #979EA8;">
                            <form method="POST" action="" name="form-delete-task">
                                <?php
                                    if (isset($_GET['tsk'])) {
                                        $tsk_id = $_GET['tsk'];
                                        ?>
                                        <button type="submit" name="delete_task" value="delete_task" style="margin: 5%; border-radius: 5px; background-color: black; color: white; width: 60%">Eliminar</button>
                                        <a href="task_page.php?tsk=<?php echo $tsk_id;?>" class="button">Cancelar</a>
                                        <?php
                                    }
                                ?>
                            </form>
